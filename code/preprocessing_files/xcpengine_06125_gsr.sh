...
cmd="${SINGULARITY_CMD} -d /home/user/data/fmriprep/fc-aroma-gsr-06125.dsn -c /home/user/data/tempcohort/${SLURM_ARRAY_TASK_ID}.csv -o /home/user/data/output_06125_gsr -r /home/user/data/ -i $TMPDIR"
