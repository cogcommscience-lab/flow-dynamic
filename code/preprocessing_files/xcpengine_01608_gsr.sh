...
cmd="${SINGULARITY_CMD} -d /home/user/data/fmriprep/fc-aroma-gsr-01608.dsn -c /home/user/data/tempcohort/${SLURM_ARRAY_TASK_ID}.csv -o /home/user/data/output_01608_gsr -r /home/user/data/ -i $TMPDIR"
